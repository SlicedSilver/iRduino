...
namespace iRacingSdkWrapper
{
    ...
    public sealed class SdkWrapper
    {
        ...
        {
            return sdk.VarHeaders.ContainsKey(name);
        }
        ...
        //            var time = (double)sdk.GetData("SessionTime");
        //            // Raise the TelemetryUpdated event and pass along the lap info and session time
        //            var telArgs = new LapTimingTelemetryUpdatedEventArgs(new TelemetryInfo(sdk), time);
        //            this.RaiseEvent(OnLapTimingTelemetryUpdated, telArgs);
        ...
        //public class LapTimingTelemetryUpdatedEventArgs : SdkUpdateEventArgs
        //{
        //    public LapTimingTelemetryUpdatedEventArgs(TelemetryInfo info, double time) : base(time)
        //    {
        //        _TelemetryInfo = info;
        //    }
